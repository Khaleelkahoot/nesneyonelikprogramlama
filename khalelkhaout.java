package khalelkhahout;

import java.util.Scanner;

public class khalelkhahout {
    ...
    public static void main(String[] args) {
        ...
        double birinciKenarUzunlugu, ikinciKenarUzunlugu, tabanUzunlugu , yukseklik,yaricap,kenarsayisi,kenarUzunluk, cokkenCevresi,cokkenAlan, ucgenCevresi, ucgenAlani;
    ...
    private static double ucgenCevresiHesapla(double x, double y, double z) {
        double cevre= x + y + z;  return cevre;}
    

    private static double ucgenAlaniHesapla(double z, double h) {
        double alan= (z*h)/2;  return alan;}
    ...
    private static double cokkenAlanHesapla(double a, double b) {
        double alana = 1/2*a*b;  return alana;}
    ...
    private static double cokkeCevreHesapla(double c, double d) {
        double cevree = c*d; return cevree;}
